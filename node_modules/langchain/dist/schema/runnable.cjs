...
exports.RunnableBinding = exports.RunnablePassthrough = exports.RunnableLambda = exports.RunnableMap = exports.RunnableSequence = exports.Runnable = void 0;
...
class RunnableSequence extends Runnable {
    ...
    async *_streamIterator(input, options) {
        ...
        let finalOutput;
        try {
            const iterator = await this.last._streamIterator(nextStepInput, this._patchConfig(options, runManager?.getChild()));
